    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-8 col-xl-6">
          <div class="row">
            <div class="col text-center">
              ...
              <p class="text-h3">Adaugati datele pentru persoana care doriti sa adaugati</p>
            </div>
          </div>
			<form action ="saveProces.php" method = "POST">
		...
		<div class="form-group">
						<input type="submit" name="save" class="btn float-right login_btn">
		</div>
					</form>
		</section>
</body>
